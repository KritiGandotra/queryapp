...
function Modal() {
  ...
  return (
    <Transition.Root show={open} as={Fragment}>
      ...
      >
        <div
          className="flex items-end justify-center mt-40 min-h-[800px] sm:min-h-screen pt-4 px-4 pb-20
        text-center sm:block sm:p-0"
        >
          <Transition.Child
            as={Fragment}
            enter="each-out duration-300"
            enterFrom="opacity-0 "
            enterTo="opacity-100 "
          ...
          >
            <div
              className="inline-block align-bottom bg-white rounded-lg px-4 pt-4 pb-4 
